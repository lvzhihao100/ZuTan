...
import com.eqdd.common.adapter.slimadapter.diff.SlimDiffUtil;
import com.eqdd.common.adapter.slimadapter.loadmore.SlimMoreLoader;
 ...
 */
public class SlimAdapterEx<D> extends SlimAdapter<D> {
    ...
    @Override
    public SlimAdapterEx updateData(List<D> data) {
        if (moreLoader != null) {
            moreLoader.reset();
        }
