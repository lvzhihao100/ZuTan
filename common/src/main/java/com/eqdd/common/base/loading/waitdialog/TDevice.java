...
public class TDevice {
	...
	public static DisplayMetrics getDisplayMetrics() {
		...
		((WindowManager) App.INSTANCE.getSystemService(
	...
	public static boolean hasBigScreen() {
		...
		if (_hasBigScreen == null) {
			boolean flag1;
			if ((0xf &  App.INSTANCE.getResources()
	...
	public static final boolean hasCamera() {
		if (_hasCamera == null) {
			PackageManager pckMgr =  App.INSTANCE
					.getPackageManager();
			boolean flag = pckMgr
	...
	public static boolean hasInternet() {
		boolean flag;
		if (((ConnectivityManager)  App.INSTANCE
	...
	public static boolean isPackageExist(String pckName) {
		try {
			PackageInfo pckInfo =  App.INSTANCE
	...
	public static void hideSoftKeyboard(View view) {
		if (view == null)
			return;
		((InputMethodManager)  App.INSTANCE.getSystemService(
	...
	public static boolean isLandscape() {
		boolean flag;
		if ( App.INSTANCE.getResources().getConfiguration().orientation == 2)
			flag = true;
		else
			flag = false;
		return flag;
	...
	public static boolean isZhCN() {
		String lang =  App.INSTANCE.getResources()
				.getConfiguration().locale.getCountry();
	...
	public static PackageInfo getPackageInfo(String pckName) {
		try {
			return  App.INSTANCE.getPackageManager()
	...
	public static int getVersionCode() {
		int versionCode = 0;
		try {
			versionCode =  App.INSTANCE
					.getPackageManager()
					.getPackageInfo(
							 App.INSTANCE.getPackageName(), 0).versionCode;
	...
	public static String getVersionName() {
		...
		try {
			name =  App.INSTANCE
					.getPackageManager()
					.getPackageInfo(
							 App.INSTANCE.getPackageName(), 0).versionName;
		} catch (NameNotFoundException ex) {
			name = "";
		}
		return name;
	...
	public static boolean isScreenOn() {
		PowerManager pm = (PowerManager)  App.INSTANCE
	...
	public static String getIMEI() {
		TelephonyManager tel = (TelephonyManager)  App.INSTANCE.getSystemService(Context.TELEPHONY_SERVICE);
	...
	public static void openApp(Context context, String packageName) {
		Intent mainIntent =  App.INSTANCE.getPackageManager()
	...
	// return;
	// ClipboardManager clip = (ClipboardManager)  App.INSTANCE
	// .getSystemService(Context.CLIPBOARD_SERVICE);
	// clip.setText(string);
	// AppContext.showToast(R.string.copy_success);
	// UIHelper.ToastMessage(UIUtils.getContext(), R.string.copy_success);
	// }
	...
	public static int getStatuBarHeight() {
		...
		try {
			...
			field = c.getField("status_bar_height");
			x = Integer.parseInt(field.get(obj).toString());
			sbar =  App.INSTANCE.getResources()
					.getDimensionPixelSize(x);
