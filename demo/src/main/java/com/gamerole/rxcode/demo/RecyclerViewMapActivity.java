...
public class RecyclerViewMapActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SlimAdapterEx slimAdapterEx = SlimAdapterExReverse.create().register(R.layout.list_item_tantan, new SlimInjector<String>() {
            @Override
...
//        dataBinding.recyclerView.scrollToPosition(1000 * strings.size());
        ...
        linearSnapHelper.setOnPosChange(curPos -> {
            System.out.println(curPos % slimAdapterEx.getData().size());
        });
    }
