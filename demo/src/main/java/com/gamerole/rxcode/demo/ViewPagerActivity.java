...
import com.gamerole.rxcode.demo.box.PageTransformer.MapTransformer;
import com.gamerole.rxcode.demo.box.ViewPagerAdapter.ImagePagerAdapter;
...
public class ViewPagerActivity extends AppCompatActivity {
    ...
    ViewPagerActivityCustom dataBinding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        dataBinding = DataBindingUtil.setContentView(this, R.layout.demo_activity_viewpager);
        ...
        dataBinding.viewPager.setOffscreenPageLimit(5);
        dataBinding.viewPager.setAdapter(new ImagePagerAdapter(this, imgUrls));
        dataBinding.viewPager.setPageTransformer(false, new MapTransformer());
    }
